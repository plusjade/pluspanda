...
define([
  ...
  /* twitter pages */
    ...
    'admin/t_widget' : function(){
      var editor = {}
       editor.wrapper = window.CodeMirror.fromTextArea('editor_wrapper', {
         width: "850px",
         height: "700px",
       ...
       editor.testimonial = window.CodeMirror.fromTextArea('editor_testimonial', {
         width: "850px",
         height: "700px",
         parserfile: "parsexml.js",
       ...
       editor.css = window.CodeMirror.fromTextArea('editor_css', {
         width: "850px",
         height: "700px",
