...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      opacity      : 0.35,
      overlay      : true,
      loadingImage : '/_assets/images/facebox/loading.gif',
      closeImage   : '/_assets/images/facebox/closelabel.gif',
	...
	<div class="facebox admin_reset" style="display:none;"> \
		<div class="popup">\
			<div class="close_wrapper"> \
				...
				</a> <div class="facebox_response" style="display:none">Server Response</div> <div class="show_submit" style="display:none"><div>Submitting...</div></div> \
			</div> \
			<div class="body"> \
